# Seed data and simple JSON database for FastAPI backend
...
INITIAL_DATA = {
    ...
    "studentTimetable": [
        ...
        { "day": "Monday", "slot": 5, "startTime": "02:00 PM", "endTime": "03:00 PM", "subjectCode": "CS311", "subjectName": "Data Structures Lab", "type": "Lab", "classroom": "LAB-1", "facultyId": "STAFF201", "facultyName": "Dr. Aris Vance" },
        { "day": "Monday", "slot": 6, "startTime": "03:00 PM", "endTime": "04:00 PM", "subjectCode": "CS311", "subjectName": "Data Structures Lab", "type": "Lab", "classroom": "LAB-1", "facultyId": "STAFF201", "facultyName": "Dr. Aris Vance" },
        ...
        # Wednesday
        { "day": "Wednesday", "slot": 1, "startTime": "09:00 AM", "endTime": "10:00 AM", "subjectCode": "CS312", "subjectName": "DBMS Lab", "type": "Lab", "classroom": "LAB-2", "facultyId": "STAFF202", "facultyName": "Prof. Sarah Connor" },
        { "day": "Wednesday", "slot": 2, "startTime": "10:00 AM", "endTime": "11:00 AM", "subjectCode": "CS312", "subjectName": "DBMS Lab", "type": "Lab", "classroom": "LAB-2", "facultyId": "STAFF202", "facultyName": "Prof. Sarah Connor" },
        ...
        { "day": "Thursday", "slot": 3, "startTime": "11:15 AM", "endTime": "12:15 PM", "subjectCode": "CS311", "subjectName": "Data Structures Lab", "type": "Lab", "classroom": "LAB-1", "facultyId": "STAFF201", "facultyName": "Dr. Aris Vance" },
        { "day": "Thursday", "slot": 4, "startTime": "12:15 PM", "endTime": "01:15 PM", "subjectCode": "CS311", "subjectName": "Data Structures Lab", "type": "Lab", "classroom": "LAB-1", "facultyId": "STAFF201", "facultyName": "Dr. Aris Vance" },
        ...
        { "day": "Friday", "slot": 5, "startTime": "02:00 PM", "endTime": "03:00 PM", "subjectCode": "CS312", "subjectName": "DBMS Lab", "type": "Lab", "classroom": "LAB-2", "facultyId": "STAFF202", "facultyName": "Prof. Sarah Connor" },
        { "day": "Friday", "slot": 6, "startTime": "03:00 PM", "endTime": "04:00 PM", "subjectCode": "CS312", "subjectName": "DBMS Lab", "type": "Lab", "classroom": "LAB-2", "facultyId": "STAFF202", "facultyName": "Prof. Sarah Connor" },
...
class LocalJSONDatabase:
    def __init__(self, filename="c:/Users/LENOVO/OneDrive/Desktop/campus_ai/backend/database.json"):
    ...
    def save(self, collection_name, item):
        ...
        # Check for matching unique keys
        unique_keys = ['id', 'code', 'regNo']
        for key in unique_keys:
            if key in item:
                # search and update
                for i, existing in enumerate(self.data[collection_name]):
    ...
    def delete(self, collection_name, key_name, key_value):
        if collection_name not in self.data:
            return False
        initial_len = len(self.data[collection_name])
        self.data[collection_name] = [x for x in self.data[collection_name] if x.get(key_name) != key_value]
        success = len(self.data[collection_name]) < initial_len
        if success:
            self.save_to_file()
        return success
